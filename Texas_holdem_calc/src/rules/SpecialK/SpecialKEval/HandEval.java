...
package rules.SpecialK.SpecialKEval;

import static rules.SpecialK.SpecialKEval.Constants.ACE;
import static rules.SpecialK.SpecialKEval.Constants.ACE_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.CAKE;
import static rules.SpecialK.SpecialKEval.Constants.CIRCUMFERENCE_SEVEN;
import static rules.SpecialK.SpecialKEval.Constants.CLUB;
import static rules.SpecialK.SpecialKEval.Constants.DECK_SIZE;
import static rules.SpecialK.SpecialKEval.Constants.DIAMOND;
import static rules.SpecialK.SpecialKEval.Constants.EIGHT;
import static rules.SpecialK.SpecialKEval.Constants.EIGHT_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_EIGHT;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_FIVE;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_FOUR;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_SEVEN;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_SIX;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_THREE;
import static rules.SpecialK.SpecialKEval.Constants.EQUITY_TWO;
import static rules.SpecialK.SpecialKEval.Constants.FIVE;
import static rules.SpecialK.SpecialKEval.Constants.FIVE_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.FOUR;
import static rules.SpecialK.SpecialKEval.Constants.FOUR_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.HEART;
import static rules.SpecialK.SpecialKEval.Constants.JACK;
import static rules.SpecialK.SpecialKEval.Constants.JACK_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.KING;
import static rules.SpecialK.SpecialKEval.Constants.KING_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.MAX_FLUSH_CHECK_SUM;
import static rules.SpecialK.SpecialKEval.Constants.MAX_FLUSH_KEY_INT;
import static rules.SpecialK.SpecialKEval.Constants.MAX_KEY_INT;
import static rules.SpecialK.SpecialKEval.Constants.MAX_NONFLUSH_KEY_INT;
import static rules.SpecialK.SpecialKEval.Constants.MAX_NUMBER_OF_PLAYERS;
import static rules.SpecialK.SpecialKEval.Constants.NINE;
import static rules.SpecialK.SpecialKEval.Constants.NINE_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.NON_FLUSH_BIT_SHIFT;
import static rules.SpecialK.SpecialKEval.Constants.NOT_A_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.NUMBER_OF_SUITS;
import static rules.SpecialK.SpecialKEval.Constants.QUEEN;
import static rules.SpecialK.SpecialKEval.Constants.QUEEN_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.SEVEN;
import static rules.SpecialK.SpecialKEval.Constants.SEVEN_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.SIX;
import static rules.SpecialK.SpecialKEval.Constants.SIX_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.SPADE;
import static rules.SpecialK.SpecialKEval.Constants.SUIT_BIT_MASK;
import static rules.SpecialK.SpecialKEval.Constants.TEN;
import static rules.SpecialK.SpecialKEval.Constants.TEN_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.THREE;
import static rules.SpecialK.SpecialKEval.Constants.THREE_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.TWO;
import static rules.SpecialK.SpecialKEval.Constants.TWO_FLUSH;
import static rules.SpecialK.SpecialKEval.Constants.UNVERIFIED;
...
public class HandEval {
	...
	//cards.Card face values beginning with ACE_ from
	...
	public String computePreFlopEquityForSpecificHoleCards(int[] holeCards, int number_of_players) {
		...
		// game.Player table key and suit stems
